...
const Step_two = () => {
  ...
  return (
    <>
      {show && (
        <div
          className={`w-auto h-auto absolute top-[-17vw] flex justify-center z-[999999]  right-[5.8vw] flex-col items-center transition duration-[2s]  `}
        ...
        >
          <div className="w-[22vw] h-[14vw]  bg-transparent  rounded-[1.5vw] relative flex justify-center items-center flex-col gap-[1.2vw] px-[1vw]">
            ...
            <p className="neuer text-[1vw] text-center ">
              Filter out factions and sub factions to get pin point access to
              forges
            </p>
            ...
            <button
              ...
              style={{
                backgroundColor: step != 2 ? "transparent" : "#CCFF00",
