  ...
  return (
    ...
    >
      <div
        ...
        }   sm:rounded-t-[5vw] sm:overflow-hidden sm:bg-white sm:relative sm:h-[70vh]  `}
        id={`brand-${index}`}
        style={{
          transition: "1s ease",
        }}
      ...
      >
        <div
          className="w-full h-[4vw] sm:h-[20vw] flex justify-between  items-center   absolute top-0 left-0 text-[1.1vw] sm:text-[4vw] sm:px-[4vw] neuem text-black px-[1vw]"
        ...
        <div className=" overflow-y-scroll admin_scroll_container h-full w-full">
